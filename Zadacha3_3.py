...
N = (int(input(f'Введите 1 , если играем в английской раскладке, либо 0, если в русской: ')))
word = input('Введите слово: ').upper()
if N == 1:
	print('За это слово вы получаете', sum([key for i in word for key, value in eng.items() if i in value]), 'очков')
elif N == 0:
	print('За это слово вы получаете', sum([key for i in word for key, value in rus.items() if i in value]), 'очков')
else:
